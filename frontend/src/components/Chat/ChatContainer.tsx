        ...
        <div className="max-w-sm w-full">
          <div className="bg-white border border-gray-200 rounded-xl p-6 shadow-sm">
            <div className="text-center mb-6">
              ...
              <h4 className="text-lg font-semibold text-gray-900 mb-2">Trip Assistant</h4>
            ...
            <div className="flex flex-wrap gap-2 justify-center">
              {initialSuggestions.map((suggestion, index) => (
                <button
                  ...
                  className="px-3 py-2 text-sm bg-blue-50 text-blue-700 border border-blue-200 rounded-lg hover:bg-blue-100 transition-colors duration-200 font-medium"
                >
                  {suggestion}
                </button>
              ))}
