    ...
    <div className="space-y-8">
      <div>
        ...
        <p className="text-gray-600">
          Review your preferences and generate your initial trip draft
        </p>
      </div>
      ...
      <div className="bg-amber-50 border border-amber-200 rounded-lg p-6">
        ...
        <div className="space-y-2 text-sm text-amber-800">
          <p>• We'll generate an initial itinerary draft based on your preferences</p>
          <p>• You'll be taken to your trip details page to customize your activities</p>
          <p>• Use our AI chat assistant to modify activities and schedule</p>
          <p>• Add, remove, or rearrange activities until it's perfect</p>
        </div>
      </div>
